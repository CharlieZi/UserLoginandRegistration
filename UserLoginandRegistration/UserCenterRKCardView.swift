...
class UserCenterRKCardView: UIView {
    
    var visualEffectView = UIVisualEffectView()
    var delegate:UserCenterRKCardViewDelegate? = nil
    
    var profileImageView = UIImageView()
    var coverImageView = UIImageView()
    var titleLabel = UILabel()
    
    var CP_RATIO:CGFloat = 0.32
    var CORNER_RATIO:CGFloat = 0.015
    var PP_RATIO:CGFloat = 0.15
...
extension UserCenterRKCardView{
