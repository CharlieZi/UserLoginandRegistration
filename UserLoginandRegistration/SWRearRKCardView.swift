...
class SWRearRKCardView: UIView {
    ...
    func setupPhotos() -> Void{
        ...
        let pp_mask:UIView = UIView(frame: CGRectMake(width * PP_X_RATIO, height * PP_Y_RATIO, height * PP_RATIO, height * PP_RATIO+0.1))
...
//        visualEffectView.alpha = 0
        ...
        coverImageView.image = UIImage(named: "cat")
    ...
    // Setup the label
        ...
        titleLabel = UILabel(frame: CGRectMake(titleLabelX - 80, cp_mask.frame.size.height - 50, self.frame.size.width - titleLabelX, 26))
